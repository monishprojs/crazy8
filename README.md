...
Important Notes:
Before building, in the index.tsx file uncomment the <React.StrictMode> before building, I only turned it off for the sake of useEffect() only loading once in my dev environment.
